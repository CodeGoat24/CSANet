...
parser.add_argument("--epoch", type=int, default='9', required=False, help="epoch for evaluation")
...
def main():
    ...
    data_dir = os.path.join('/data/CodeGoat24/placement_result', args.expid, args.eval_type, str(args.epoch))
