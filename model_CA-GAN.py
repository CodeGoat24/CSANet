...
from network import vgg16_bn, FgBgRegression, VAEEncoder, CrossAtt, FeatExtractor
...
class SysNet(nn.Module):
    ...
    def initialize_weight(self):
        for m in [self.fg_extractor, self.bg_extractor, self.latent_extractor, self.att, self.vae_enc, self.regress_net]:
    ...
    def forward(self, bg_img, fg_img, fg_msk, fg_bbox, comp_img=None, comp_msk=None):
        ...
        attn_feats_1, attn_feats_fg, attn_feats_bg, attn_1, attn_2 = self.att(fg_feats, bg_feats)
